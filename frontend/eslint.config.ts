...
export default defineConfigWithVueTs(
  ...
  {
    // Components generated by `shadcn-vue add`, kept under their generated names so that running
    // the generator again produces the same files rather than a second copy under another name.
    // `Select.vue` and `Checkbox.vue` are single words because the whole ecosystem calls them
    // that; renaming them here would be arguing with a convention this project chose to adopt.
    name: 'substate-admin/generated-components',
